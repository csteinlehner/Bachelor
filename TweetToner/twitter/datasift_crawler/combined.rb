...
hashes = {"rosenheim" => "db6cd2371313e968d8fe83fb86499d29", "berlin" => "802182644f35e61cf07bbaba8af71ba5"}
...
consumer = user.getConsumer(DataSift::StreamConsumer::TYPE_HTTP, "#{hashes["rosenheim"]},#{hashes["berlin"]}")
...
consumer.consume(true) do |interaction|
    ...
    case interaction["hash"]
    when hashes["rosenheim"]
      puts "Rosenheim"
    when hashes["berlin"]
      puts "Berlin"
    else
      puts "Strange hash? " + interaction["hash"]
    end
		# data = interaction
