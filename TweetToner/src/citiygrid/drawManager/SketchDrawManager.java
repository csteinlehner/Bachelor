...
public class SketchDrawManager implements DrawManager{
...
//		pattern.endShape();
		...
		h.ellipse(mid.x, mid.y, iconSize, iconSize);
		pattern.tint(c.toARGB());
		tile.resize(iconSize, iconSize);
		pattern.image(tile,mid.x-tile.width/2,mid.y-tile.height/2);
		pattern.endDraw();
